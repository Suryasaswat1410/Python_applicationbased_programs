...
There are also privileged customers who can earn bonus points for each of their transaction.
...
PrivilegedCustomer
__init__ (customer_id, customer_name, age, account,bonus_points)
+withdraw (amount)
+get_bonus_points()
-increase_bonus()
OverdrawException
...
a = Account("Savings",1800,500)
c = Customer("100","Surya",21,a)
